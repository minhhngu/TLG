...
def main():
    ...
    setcode = input(
        "What is the code of the set you are trying to lookup (see mtgsets.index for a list of codes)? ").lower()  # collect user input for MTG card set to lookup
    ...
    with open(f'{setcode}_cards.set', "w") as f: # writes to file
        json.dump(cards, f)
